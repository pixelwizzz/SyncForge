...
export const TASKS: Task[] = [
  {
    id: "t1",
    title: "Review API schema for v2 endpoints",
    status: "todo",
    priority: "high",
    assignee: { name: "Priya", initials: "PR" },
    due: "May 28",
    team: "Backend",
  },
  {
    ...
    status: "todo",
    priority: "low",
    assignee: { name: "Mira", initials: "MI" },
    due: "Jun 02",
    team: "Design",
  },
  {
    id: "t3",
    title: "Audit auth flow for edge cases",
    status: "todo",
    priority: "medium",
    assignee: { name: "Arjun", initials: "AR" },
    due: "May 30",
    team: "Backend",
  },
  {
    id: "t4",
    title: "Fix Redis connection timeout under load",
    status: "in_progress",
    priority: "urgent",
    assignee: { name: "Priya", initials: "PR" },
    due: "Today",
  ...
  },
  {
    ...
    status: "in_progress",
    priority: "high",
    assignee: { name: "Rahul", initials: "RA" },
    due: "May 27",
    team: "Backend",
  },
  {
    id: "t6",
    title: "Refine empty-state illustrations",
    status: "review",
    priority: "low",
    assignee: { name: "Mira", initials: "MI" },
    due: "May 29",
  ...
  {
    id: "t8",
    title: "Write changelog for May release",
    status: "done",
    priority: "low",
    assignee: { name: "Priya", initials: "PR" },
    due: "May 21",
